...
class Version20171027182951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(sprintf("INSERT INTO role_user (user_id, role_id) VALUES(%d, %d)", 1, Role::USER));
        $this->addSql(sprintf("INSERT INTO role_user (user_id, role_id) VALUES(%d, %d)", 2, Role::ROOT));
